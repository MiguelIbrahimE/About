...
function Prometheus() {
    ...
    const handleBackClick = () => {
        navigate('/'); // This navigates to the root route, which should be your App component.
    };
        ...
        <div className="prometheus-page" style={{ color: colorBlack }}>
            <nav className="prometheus-navbar" style={{ backgroundColor: colorBlack }}>
                ...
                <ul className="prometheus-nav-links">
                    <li>
                        <button onClick={handleBackClick} className="prometheus-nav-link" style={{ color: colorBrown }}>
                            Back
                        </button>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="https://example.com/votinator" rel="noopener noreferrer" className="prometheus-nav-link" style={{ color: colorBrown }}>
                            Votinator
                        </a>
                    </li>
                </ul>
                ...
                <div className="prometheus-project-grid">
                    ...
                    <div className="prometheus-grid-item">
                        ...
                        <div className="prometheus-grid-text-container">
                            ...
                            <br />
                            <span className="prometheus-grid-text">To provide easy code snippets based on their desires.</span>
                            <br />
                    ...
                    <div className="prometheus-grid-item">
                        ...
                        <div className="prometheus-grid-text-container">
                            ...
                            <br />
                            <span className="prometheus-grid-text">A mission to simplify and maintain</span>
                        </div>
                    </div>
                </div>
            </section>
